 ...
 * <b>クラス名称　　　:</b>受講者マスタメンテナンス【単票】Modelクラス。<br>
 * <b>クラス概要　　　:</b>受講者マスタメンテナンス【単票】Model。<br>
 * <br>
 * <b>著作権　　　　　:</b>All rights recerved, Copyright(C), nai INDUSTRIES, LTD.
 * @author TECS
 * <b>変更履歴　　　　:</b>2013/07/1 TECS 新規作成。
 */
public class StudentMstModel implements Model {
...
//2013/09/25-Del-End
     ...
     * @return insert_cd
     */
    public String getInsert_cd() {
        return insert_cd;
    }

    /**
     * @param insert_cd セットする insert_cd
     */
    public void setInsert_cd(String insert_cd) {
        this.insert_cd = insert_cd;
    }
    ...
    /**
     * @param update_cd セットする update_cd
     */
