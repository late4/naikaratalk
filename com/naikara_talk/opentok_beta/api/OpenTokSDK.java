...
import com.naikara_talk.opentok_beta.api.constants.SessionProperties;
import com.naikara_talk.opentok_beta.api.constants.RoleConstants;
import com.naikara_talk.opentok_beta.exception.OpenTokException;
import com.naikara_talk.opentok_beta.util.Base64;
import com.naikara_talk.opentok_beta.util.GenerateMac;
import com.naikara_talk.opentok_beta.util.TokBoxXML;
import com.naikara_talk.opentok_beta.api.OpenTokSession;
...
public class OpenTokSDK {
    ...
    public OpenTokSession create_session(String location, SessionProperties properties) throws Exception {
    ...
    public OpenTokSession create_session() throws Exception {
		return create_session(null, new HashMap<String, String>());
	}


    public OpenTokSession create_session(String location) throws Exception {
		return create_session(location, new HashMap<String, String>());
	}

    public OpenTokSession create_session(String location, Map<String, String> params) throws Exception {
	...
	protected TokBoxXML do_request(String url, Map<String, String> params) throws Exception {
