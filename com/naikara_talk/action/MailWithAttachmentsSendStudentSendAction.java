 ...
 */
public class MailWithAttachmentsSendStudentSendAction extends MailWithAttachmentsSendActionSupport {
    ...
    public String requestService() throws NaiException {
        ...
        try {
            ...
            sb.append(model.getTeacherId()).append(MailWithAttachmentsSendSendService.COLON)
                    .append(model.getTeacherNickNm());

            // メッセージ
            this.message = getMessage("IC0015", new String[] { sb.toString() });
