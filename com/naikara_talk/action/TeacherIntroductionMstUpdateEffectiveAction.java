 ...
 *
 */
public class TeacherIntroductionMstUpdateEffectiveAction extends TeacherIntroductionMstAction implements SessionAware{
	...
	public String requestService() throws NaiException {
    	...
    	/** 更新処理 */
    	TeacherIntroductionMstModel model = introService.updateEffective(introService.reload(formData));
