 ...
 */
public class StudentLessonHistoryTeacherUsesListSearchAction extends StudentLessonHistoryTeacherUsesListActionSupport {
    ...
    public String requestService() throws NaiException {
        ...
        if (!returnOnFlg) {
            ...
            try {
                ...
                // 検索前チェックを行う
                chkResult = service.checkPreSelectT(this.model);
        ...
        try {
            ...
            if (!returnOnFlg || StringUtils.equals(NaikaraTalkConstants.TRUE, this.hasSearchFlg)) {
                ...
                // 検索結果
                this.model.setResultList(service.selectListT(this.model));
