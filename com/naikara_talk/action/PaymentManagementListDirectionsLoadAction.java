 ...
 * <b>クラス概要       :</b>講師毎の支払管理表初期処理Action<br>
 * <br>
 * <b>著作権           :</b>All rights recerved, Copyright(C), nai INDUSTRIES, LTD.
 * @author TECS
 * <b>変更履歴         :</b>2013/07/08 TECS 新規作成
 */
public class PaymentManagementListDirectionsLoadAction extends PaymentManagementListDirectionsActionSupport {
    ...
    public String requestService() throws NaiException {
        ...
        // 支払年月初期値設定
        this.payment_txt = DateUtil.getSysDateYM();
