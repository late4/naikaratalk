 ...
 * <b>クラス名称　　　:</b>レッスン予実テーブルクラス<br>
 * <b>クラス概要　　　:</b>レッスン予実テーブルDTO<br>
 * <br>
 ...
 */
public class LessonReservationPerformanceTrnDto extends AbstractDto {
    ...
    private String salesAccruedFlg;          // 売上計上済フラグ
    private String dailyBatchFlg;            // 日次作成フラグ

    // 2014/01/15 FlashからTokboxに変更対応 upd start
    ...
    private File lessonPDF;                  // レッスンファイル
    // 2014/01/15 FlashからTokboxに変更対応 upd end

    // 2014/04/22 Add Start レッスンファイルのコンテンツタイプの追加対応(pdf⇒pdf、txt)
    private String lessonFileContentType;    // Tokbox用トークンID
    ...
    // 画面処理必要項目
    private String periodDtFr;               // 抽出開始日
    private String periodDtTo;               // 抽出終了日
    private String lessonDtFr;               // レッスン開始日
    private String lessonDtTo;               // レッスン終了日
    ...
    private String courseJnmAll;             // コース名各分類共
    private String courseEnmAll;             // コース名(英語)各分類共
    private String role;                     // ロール

    // 2014/06/02 レッスン予約に関する「応相談」対応 Add Start
    // 画面処理必要項目(受講者マイページ)
    private String reservationKbn;           // 講師予定予約テーブル：予約区分(予約状況)
    private String reservationKbnJnm;        // 講師予定予約テーブル：予約区分(予約状況) 表示名
     ...
     * <br>
     * @param なし<br>
     * @return courseJnmAll コース名各分類共<br>
     * @exception なし
     */
     ...
     * コース名各分類共設定を行う<br>
     * <br>
     * @param courseJnmAll コース名各分類共<br>
     * @return なし<br>
     * @exception なし
     */
     ...
     * コース名(英語)各分類共取得<br>
     * <br>
     * コース名(英語)各分類共取得を行う<br>
     * <br>
     * @param なし<br>
     * @return courseEnmAll コース名(英語)各分類共<br>
     * @exception なし
     */
     ...
     * コース名(英語)各分類共設定<br>
     * <br>
     * コース名(英語)各分類共設定を行う<br>
     * <br>
     * @param courseEnmAll コース名(英語)各分類共<br>
     * @return なし<br>
     * @exception なし
     */
     ...
     * 売上計上済フラグ取得<br>
     * <br>
     * 売上計上済フラグを戻り値で返却する<br>
     * <br>
     * @return salesAccruedFlg
     */
    public String getSalesAccruedFlg() {
        return salesAccruedFlg;
    }
     ...
     * 売上計上済フラグを引数で設定する<br>
     * <br>
     * @param salesAccruedFlg
     */
    public void setSalesAccruedFlg(String salesAccruedFlg) {
        this.salesAccruedFlg = salesAccruedFlg;
    }
...
//    }
     ...
     * @return lessonPDF
     */
    public File getLessonPDF() {
        return lessonPDF;
    }

    /**
     * @param lessonPDF セットする lessonPDF
     */
    public void setLessonPDF(File lessonPDF) {
        this.lessonPDF = lessonPDF;
    }
    // 2014/01/15 FlashからTokboxに変更対応 end

    // 2014/04/22 Upd Start レッスンファイルのコンテンツタイプの追加対応(pdf⇒pdf、txt)
    /**
    ...
    // 2014/04/22 Upd End レッスンファイルのコンテンツタイプの追加対応(pdf⇒pdf、txt)
    ...
    // 2014/06/02 レッスン予約に関する「応相談」対応 Add Start
    /**
     * 講師予定予約テーブル：予約区分(予約状況) 取得<br>
     * <br>
     * 講師予定予約テーブル：予約区分(予約状況) 取得を行う<br>
     * <br>
     * @param なし<br>
     * @return reservationKbn 講師予定予約テーブル：予約区分(予約状況) <br>
     * @exception なし
     */
    ...
    /**
     * 講師予定予約テーブル：予約区分(予約状況) 設定<br>
     * <br>
     * 講師予定予約テーブル：予約区分(予約状況) 設定を行う<br>
     * <br>
     * @param reservationKbn 講師予定予約テーブル：予約区分(予約状況) <br>
     * @return なし<br>
     * @exception なし
     */
    ...
    /**
     * 講師予定予約テーブル：予約区分(予約状況)表示名 取得<br>
     * <br>
     * 講師予定予約テーブル：予約区分(予約状況)表示名 取得を行う<br>
     * <br>
     * @param なし<br>
     * @return reservationKbnJnm 講師予定予約テーブル：予約区分(予約状況)表示名 <br>
     * @exception なし
     */
    ...
    /**
     * 講師予定予約テーブル：予約区分(予約状況)表示名 設定<br>
     * <br>
     * 講師予定予約テーブル：予約区分(予約状況)表示名 設定を行う<br>
     * <br>
     * @param reservationKbnJnm 講師予定予約テーブル：予約区分(予約状況)表示名 <br>
     * @return なし<br>
     * @exception なし
     */
