 ...
 */
public class TeacherMstDto extends AbstractDto {
    ...
    private String overseaAbanoSwiftcdBiccd;        // 海外送金の場合:ABAナンバー/SWIFTコード/BIC
    // Code　等
    ...
    // 画面処理必要項目
    private File imgPhotoPage;                      // 講師画像
    private String imgPhotoChkn;                      // 講師画像削除
    ...
    public String getImgPhotoChkn() {
        if (this.imgPhotoChkn == null) {
            this.imgPhotoChkn = NaikaraTalkConstants.FALSE;
        }
        return imgPhotoChkn;
    }
