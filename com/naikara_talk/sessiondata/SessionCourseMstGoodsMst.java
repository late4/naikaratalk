 ...
 */
public class SessionCourseMstGoodsMst implements SessionData {

    /** ヘッダの戻るリンク用のSessionKey */
    private static final String HEADER_RETURN_KEY = "CourseMst";
    ...
    /** コース別利用ポイントマスタリスト */
    private List<CourseUsePointMstDto> courseUsePointMstList;

    /** 一時保存のコース別利用ポイントマスタリスト */
    private List<CourseUsePointMstDto> tempCourseUsePointMstList;
    ...
    /**
     * @return bytExplanation6
     */
    public byte[] getBytExplanation6() {
        return bytExplanation6;
    }

    /**
     * @param bytExplanation6 セットする bytExplanation6
     */
    public void setBytExplanation6(byte[] bytExplanation6) {
        this.bytExplanation6 = bytExplanation6;
    }
    ...
    /**
     * @return courseUsePointMstList
     */
    public List<CourseUsePointMstDto> getCourseUsePointMstList() {
        if (this.courseUsePointMstList == null) {
            this.courseUsePointMstList = new ArrayList<CourseUsePointMstDto>();
        }
        return courseUsePointMstList;
    }

    /**
     * @param courseUsePointMstList セットする courseUsePointMstList
     */
    public void setCourseUsePointMstList(List<CourseUsePointMstDto> courseUsePointMstList) {
        this.courseUsePointMstList = courseUsePointMstList;
    }

    /**
     * @return tempCourseUsePointMstList
     */
    public List<CourseUsePointMstDto> getTempCourseUsePointMstList() {
        if (this.tempCourseUsePointMstList == null) {
            this.tempCourseUsePointMstList = new ArrayList<CourseUsePointMstDto>();
        }
        return tempCourseUsePointMstList;
    }

    /**
     * @param tempCourseUsePointMstList セットする tempCourseUsePointMstList
     */
    public void setTempCourseUsePointMstList(List<CourseUsePointMstDto> tempCourseUsePointMstList) {
        this.tempCourseUsePointMstList = tempCourseUsePointMstList;
    }
