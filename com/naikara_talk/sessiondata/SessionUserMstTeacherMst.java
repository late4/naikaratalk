 ...
 */
public class SessionUserMstTeacherMst implements SessionData {

    /** ヘッダの戻るリンク用のSessionKey */
    private static final String HEADER_RETURN_KEY = "TeacherMst";
    ...
    /** 一時保存の講師支払比率 */
    private List<TeacherRateMstDto> tempResultList;
     ...
     */
    public List<TeacherRateMstDto> getTempResultList() {
        if (null == this.tempResultList) {
            this.tempResultList = new ArrayList<TeacherRateMstDto>();
        }
        return tempResultList;
    }

    /**
     * @param tempResultList セットする tempResultList
     */
    public void setTempResultList(List<TeacherRateMstDto> tempResultList) {
     ...
     * @return bytImgPhoto
     */
    public byte[] getBytImgPhoto() {
        return bytImgPhoto;
    }

    /**
     * @param bytImgPhoto セットする bytImgPhoto
     */
    public void setBytImgPhoto(byte[] bytImgPhoto) {
        this.bytImgPhoto = bytImgPhoto;
    }
